...
const Error = () => {
    return (
        ...
        <div className="">
            <div className="alert alert-danger d-flex align-items-center justify-content-center m-3" role="alert">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-exclamation-octagon m-2" viewBox="0 0 16 16">
                ...
                <div>
                    Error 404, la URL es inexistente
                </div>
            </div>
        </div>
